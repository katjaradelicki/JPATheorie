...
<html lang="nl">
  ...
  <body>
    ...
    <form action="<c:url value='/docenten/toevoegen.htm'/>" method="post"
      id="toevoegform">
      <label>Voornaam:
        <input name="voornaam" value="${param.voornaam}" autofocus/></label>
      <label>Familienaam:
        <input name="familienaam" value="${param.familienaam}"/></label>
      <label>Wedde:
        <input name="wedde" value="${param.wedde}" type="number"/></label>
      <div><label>
